...
\begin{tabular}{ccccccc}
    ...
    NM08 \Gls{stimulation}  & Northern & 6-8-2012 & 7-10-2012 & River water & 175 & 2.63 (WHP)\\
    NM10 Drilling  & Southern & 5-25-2012 & 8-11-2012 & Drilling fluid & 141 & N/A  \\
    NM10 \Gls{stimulation}  & Southern & 9-1-2012 & 9-23-2012 & River water & 201 & 9.3 (DHP) \\
    NM09 \Gls{stimulation} A  & Northern & 12-14-2012 & 1-4-2013 & River water & 170 & 0.2 (WHP); 15.3 (DHP) \\
    NM09 \Gls{stimulation} B  & Northern & 2-13-2013 & 3-6-2013 & Brine & 152 & 0.3 (WHP); 13.0 (DHP)  \\
\end{tabular}}
...
Phase two of the \gls{stimulation} began on 1 July, 2012 (start of RP, Figure \ref{645772}) at slightly higher \glspl{flow_rate} than previously ($\sim$150 t/h). Again, the rate of seismicity did not immediately increase once the second phase of injection began. There was a delay of approximately four days before the \gls{flow_rate} was increased to $\sim$175 t/h with an accompanying increase in \acrshort{WHP} of approximately 0.5 MPa (FZ2 Figure \ref{645772}). Following this increase, the rate of seismicity increased to 23 events per day (T5), slightly higher than the levels encountered during phase one. This activity ceased as soon as injection was halted on 9 July, bringing the total number of events during the \gls{stimulation} to 122. The maximum $M_{L}$ during the entire \gls{stimulation} was 2.1.\selectlanguage{english}
...
The fitting of isotropic pore-pressure diffusion curves to the NM08 data (for either scenario), is not convincing and is not necessary to explain the location of the seismicity. It is likely that highly anisotropic \gls{permeability} at the \textless1 km scale in Ngatamariki, invalidates such simple modeling of the migration of fluid and pressure.\selectlanguage{english}

\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.70\columnwidth]{Chapter_3_Nga/figures/NM08_SBRC/NM08_stimulation_GrowClust_diffs_fz&centroid_11-10}
...
\subsection{Maximum magnitude}\label{mmax}
...
\subsection{$b$-value mapping}\label{bval_map}
